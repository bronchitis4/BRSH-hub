...
const PostsList = () => {
    return (
        <div className="h-full overflow-y-auto">
            <div className="flex flex-col items-center gap-y-4 py-10 px-0  md:p-10">
                <PostsListItem/>
                <PostsListItem/>
                <PostsListItem/>
                <PostsListItem/>
